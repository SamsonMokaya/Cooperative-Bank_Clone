...
<body>
  <div class="v108_22">
    ...
    <div class="v108_25"><span class="v108_26">
      <a href="<?= base_url("signUpPage/") ?>" style="text-decoration: none; color:white;"> Sign In </a>
    </span></div>
    <div class="v115_2">
      <div class="container">
        <div class="row" style="text-align: center; margin-left:10%; margin-right:10%;">
          ...
          <form action="<?= base_url("signUserIn/") ?>" method="POST">
            ...
            <button type="submit" class="btn btn-success" style="padding:1%; margin-left:40%; margin-right:40%;"> Sign In</button>
          </form>
        </div>
      </div>
    </div>
